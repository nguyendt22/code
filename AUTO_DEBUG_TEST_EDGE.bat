...
cls
echo ========================================
echo  AUTO DEBUG TEST - EDUMATH AI (EDGE)
echo ========================================
echo.
echo Dang tu dong:
echo 1. Restart server
echo 2. Mo Microsoft Edge voi Console
...
REM Open Edge with dev tools
echo [3/4] Mo Microsoft Edge...
start msedge.exe "http://localhost:3000" --auto-open-devtools-for-tabs

echo.
echo ========================================
echo  XONG! Edge da mo voi Console
echo ========================================
echo.
echo HUONG DAN:
echo.
echo 1. Trong Edge, tab Console da mo san
